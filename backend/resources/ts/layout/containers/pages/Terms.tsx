...
const EnhancedTerms: React.FC = () => {
    const aboutTerm = 'この利用規約（以下，本規約」といいます。）は，PressPlace運営者（以下，「運営者」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。ユーザーの皆さまには､本規約に従って，本サービスをご利用いただきます。'
    const term1 = {
        title: '第1条（適用）',
        contents: [
