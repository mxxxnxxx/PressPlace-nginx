...
class User extends Authenticatable implements MustVerifyEmailContract
{
    ...
    {
        return $this->belongsToMany(self::class, 'user_follow', 'user_id', 'follow_id')->withTimestamps();
    }

    // ユーザーのフォロワーを取得する
    public function followers()
    {
        return $this->belongsToMany(self::class, 'user_follow', 'follow_id', 'user_id')->withTimestamps();
    }
